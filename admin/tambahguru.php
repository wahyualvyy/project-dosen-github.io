                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="modal-body">
                            <form action="../function/tambah_guru.php" method="post">
                              <fieldset>
                    ...
                    <tbody>
                      ...
                      <?php foreach ($query as $gr): ?>
                        <tr>
                          ...
                          <td>
                          <a href="../function/update_guru.php?Noid=<?= $gr["id"]; ?>"><button type="button"
                            ...
                            <a href="../function/hapus_guru.php?Noid=<?= $gr["id"]; ?>"><button type="button"
