            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <form action="../function/absensi_guru_proses.php" method="post">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      if ($querySiswa)
                      {
                        while ($pecahSiswa = mysqli_fetch_assoc($querySiswa))
                        {
                          ?>
                        <tr>
                          <td>
                          ...
                          <td>
                            <?= $pecahSiswa['nis'] ?><input type="hidden" name="nis[]" value="<?= $pecahSiswa['nis'] ?>">
                          </td>
                          <td>
                            <?= $pecahSiswa['nama'] ?>
                          </td>
